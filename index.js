...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.jfiige1.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
    try {
        ...
        const reviewsCollection = client.db("E-learning-web").collection("reviews");
        const addtocartCollection = client.db("E-learning-web").collection("additems");
        const userCollection = client.db("E-learning-web").collection("users");
        const paymentCollection = client.db("E-learning-web").collection("payment");
